package com.wanblog.log.okhttp;

import com.wanblog.log.LogUtil;
import com.wanblog.log.LogUtilHelper;
...
public final class HttpLoggingInterceptorM implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        Utils.INSTANCE.writerLog(requestStartMessage);
        ...
        Utils.INSTANCE.writerLog("<-- " + response.code() + ' ' + response.message() + ' ' + response.request()
        ...
        if (logHeaders) {
            ...
            if (!logBody || !HttpHeaders.hasBody(response)) {
                ...
                if (contentLength != 0) {
                    ...
                    Utils.INSTANCE.writerLog(buffer.clone()
                            .readString(charset));
                }
