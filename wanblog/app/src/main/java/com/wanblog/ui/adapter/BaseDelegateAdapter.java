...
public class BaseDelegateAdapter extends DelegateAdapter.Adapter<BaseViewHolder> {
    ...
    protected BaseDelegateAdapter(Context context, LayoutHelper layoutHelper, int layoutId, int count, int viewTypeItem, VirtualLayoutManager.LayoutParams layoutParams) {
